...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <style>
            ...
            .loading-overlay {
                ...
                background: rgba(208, 207, 207, 0.433);
                z-index: 9999;
                align-items: center;
    ...
    <body>
        ...
        <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">TEFL ITATS</a>
        ...
        <div class="loading-overlay" id="loading-overlay">
            <svg class="loading-container" viewBox="0 0 40 40" height="40" width="40">
                <circle 
                    class="track"
                    cx="20" 
                    cy="20" 
        ...
        <div class="wrapper d-flex align-items-stretch">
            @include('homeuser.layouts.sidebar')
